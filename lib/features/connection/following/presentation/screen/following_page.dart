...
class _FollowingPageState extends ConsumerState<FollowingPage> {
  ...
  void _onScroll() {
    ...
    if (currentScroll >= threshold) {
      // Step 3.4: Load more following
      _loadMoreFollowing();
    }
  }

  Future<void> _loadMoreFollowing() async {
    // Step 4.1: Get the notifier (controller) for following
    ...
    try {
      ...
      await notifier.loadMoreFollowing();
    } finally {
  ...
  Future<void> _onRefresh() async {
    await ref.read(followingProvider.notifier).refreshFollowing();
  }
